...
- Copy the astroid-webview `public/` assets into this app's `public/` (keep same relative paths): Cyberpunk.hdr, rubber_tiles_diff_2k.jpg, rubber_tiles_nor_gl_2k.jpg, rubber_tiles_rough_2k.jpg, rocks_ground_09_diff_2k.jpg, plastered_wall_05_diff_2k.jpg, the robot .glb, icons/_.png (happy/sad/confused/mad), sounds/_.mp3 (beep/siren/success/error), levels*.json.
