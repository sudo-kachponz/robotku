        ...
        <div className={styles.modalContent}>
          <div className={styles.textContent}>
            {!caps?.secureContext && (
              ...
              >
                ⚠️ <strong>Peringatan HTTP:</strong> Aplikasi dibuka tanpa HTTPS (non-secure
                context). Browser memblokir fitur Bluetooth & Serial demi keamanan.
              </div>
            )}
            ...
            >
              <h4
                style={{ margin: '0 0 6px', color: '#15803D', fontSize: '14px', fontWeight: 800 }}
              >
                ✨ Mode Belajar Aktif!
              </h4>
